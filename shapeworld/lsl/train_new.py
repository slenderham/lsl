...
if __name__ == "__main__":
    ...
    if (args.use_relational_model and "_slot" in args.aux_task):
        image_relation_model = ExWrapper(TransE(64, args.hidden_size)).to(device)
    ...
    after_scheduler = optim.lr_scheduler.CosineAnnealingLR(pretrain_optimizer, T_max=100*args.pt_epochs-1000)
