...
which in turn is modified from https://github.com/facebookresearch/low-shot-shrink-hallucinate
"""
...
class ConvNetSNopool(nn.Module):
    # Relation net use a 4 layer conv with pooling in only first two layers,
    # else no pooling. For omniglot, only 1 input channel, output dim is
    # [64,5,5]
